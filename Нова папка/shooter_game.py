...
for i in range(1, 3):
    monsterB = Enemy('Raven-Flying-PNG-HD.png', 0, randint(50, 650), 200, 100, randint(2,4), 4)
    monstersB.add(monsterB)

monsters = sprite.Group()
for i in range(1,8):
    monster = Enemy('Raven-Flying-PNG-HD.png', 0, randint(50, 650), 80, 50, randint(3,5), 1)
...
ship = Player('stalker_PNG10.png', 930, win_height - 150, 150, 150, 15)
finish = False
run = True
while run:
    for e in event.get():
